...
inboxcreate = requests.get("http://api.kopeechka.store/mailbox-get-email?site=tiktok.com&mail_type=mail.com&token=83ce0015b39bbe41c3a9152b717798d4")
...
time.sleep(15)
getcode = requests.get(f"http://api.kopeechka.store/mailbox-get-message?id={inboxid}&token=83ce0015b39bbe41c3a9152b717798d4&api=2.0")
